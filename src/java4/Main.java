...
//                    System.out.println("@@@@@"+캐릭터.회복물약가방.get(상점판매-1).스택수);
                    if(입력 <=캐릭터.회복물약가방.get(상점판매-1).스택수) {//스택수 이하의 숫자를 입력했을 때
                        세부2 = 0;
                        판매개수 = 입력;
                        상점판매확인1 = true;
                        입력 = -1;
...
//                }
            ...
            //4-0-0 시작
            {
                ...
                if (화면 == 4 && 세부1 == 1 && 세부2 == 0 && 입력 >= 1 && 입력 <=캐릭터.강화목록.size()) {
                    세부2 = 1;
                ...
                if (화면 == 4 && 세부1 == 2 && 세부2 == 0 && 입력 >= 1 && 입력 <= 캐릭터.강화목록.size()) { //420에서 1이상을 선택
                    아이템정보 = 캐릭터.강화목록.get(입력 -1);
                    살펴보기출력=true;
                    입력 = -1;
                }
            }
...
//                    몬스터타겟 = null;
                ...
                if (화면 == 5 && 세부1 == 2 && 세부2 == 0 && 입력 >= 1 && 입력 <= 캐릭터.스킬목록.size()) {
                    스킬 = 캐릭터.스킬목록.get(입력 -1);
                    세부2 = 1;
                    입력 = -1;
                }

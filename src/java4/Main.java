...
//                    }
                    ...
                    System.out.println(메인.능력치창());
                    System.out.println(메인.상점구매목록(상점));
                    System.out.print("" +
                    ...
                    System.out.println(메인.능력치창());
                    System.out.print(메인.행동상점구매목록(상점));
                    System.out.print("" +
                            "\n└──────────────────" +
                            "\n구매할 아이템을 선택하세요." +
                            "\n→");
                    ...
                    if(상점판매<=2){ //상점판매가 2이하면
                        System.out.println(플레이어.회복물약가방.get(상점판매-1).아이템이름+
                                "(보유량: " + 플레이어.회복물약가방.get(상점판매-1).스택수+"개)"+
                                "을(를) 몇 개 판매하시겠습니까?\n(0개: 취소)" +
                                "\n→");
                    } else { //상점판매가 3이상이면
                        System.out.print("" +
                                플레이어.소지품.get(상점판매-3).아이템이름 +
                                "(보유량: " + 플레이어.소지품.get(상점판매-3).스택수+"개)"+
                                "을(를) 몇 개 판매하시겠습니까?\n(0개: 취소)" +
                                "\n→");
                    }
                    ...
                    System.out.print("" +
                            플레이어.소지품.get(상점판매-3).아이템이름 +
                            "을(를) "+ 플레이어.소지품.get(상점판매-3).판매가격+"골드에 판매하시겠습니까?" +//변수 '상점구매' 값에 따라 품목 이름을 바꿔넣기
                            "\n0.취소" +
                            "\n1.확인" +
                            "\n→");
...
//            }
            ...
            //1-0-0 시작
            {
                if (화면 == 1 && 세부1 == 0 && 세부2 == 0 && 입력 == 1) {
                    화면 = 2;
                    입력 =-1;
                }
                if (화면 == 1 && 세부1 == 0 && 세부2 == 0 && 입력 == 2) {
                    화면 = 1;
                    세부1 = 2;
                    입력 =-1;
                }
                if (화면 == 1 && 세부1 == 0 && 세부2 == 0 && 입력 == 3) {
                    화면 = 3;
                    입력 =-1;
                }
                if (화면 == 1 && 세부1 == 0 && 세부2 == 0 && 입력 == 4) {
                    화면 = 4;
                    입력 =-1;
                }
                if (화면 == 1 && 세부1 == 0 && 세부2 == 0 && 입력 == 5) {
                    화면 = 2;
                    세부1 = 4;
                ...
                //1-1-0은 없음
                if (화면 == 1 && 세부1 == 2 && 세부2 == 0 && 입력 == 0) {
                    세부1 = 0;
                    입력 = -1;
                }
                if (화면 == 1 && 세부1 == 2 && 세부2 == 0 && 입력 == 1) {
                    세부2=1;
                    입력 =-1;
                }
                if (화면 == 1 && 세부1 == 2 && 세부2 == 0 && 입력 == 2) { //120에서 2(버리기)를 누를경우
                    세부2=2;
                    입력 =-1;
                }
                if (화면 == 1 && 세부1 == 2 && 세부2 == 0 && 입력 == 3) { //120에서 3(살펴보기)를 누를경우 130(살펴보기)로 감.
                    세부1=3;
                    입력 =-1;
                }
                if (화면 == 1 && 세부1 == 2 && 세부2 == 1 && 입력 == 0) { //
                    세부2 = 0;
                    입력 = -1;
                }
                if (화면 == 1 && 세부1 == 2 && 세부2 == 1 && 입력 >=1 && 입력 <=전체가방크기) {//
                    아이템사용=true; //아이템 사용 스크립트 실행용
                    //이 아래는 버리기와 장착하기 에도 동일하게 쓰임
                    if(입력 <=회복물약가방크기){ //회복물약 내용물을 선택했다면
                        사용선택= 입력 -1;
                        물약여부=1;
                        if(플레이어.회복물약가방.get(사용선택).스택수==0){ //선택한 물약의 스택수가 0개라면
//                            System.out.println("스택수0개");
                            아이템사용=false;
                            System.out.println("\n"+ 플레이어.회복물약가방.get(사용선택).아이템이름+"이 부족합니다.");
                            Thread.sleep(1000);
//                            세부2=1;
                            물약여부=0;
                            사용선택=-1;
                        ...
                        사용선택 = 입력 -(회복물약가방크기+1);
                        if(플레이어.소지품.get(사용선택).사용가능여부) { //사용가능한 물건이라면
                            물약여부 = 2;
                        }
                        else{ // 사용 불가능한 물건이라면
                            아이템사용=false;
...
//                    System.out.println("물약여부 : " + 물약여부);
                ...
                if (화면 == 1 && 세부1 == 2 && 세부2 == 2 && 입력 == 0) {
                    세부2 = 0;
                    입력 = -1;
                }
                if (화면 == 1 && 세부1 == 2 && 세부2 == 2 && 입력 >=1 && 입력 <=전체가방크기) {//사용하기 복사한 버리기
                ...
                if (화면 == 1 && 세부1 == 3 && 세부2 == 0 && 입력 == 0) {
                    세부1 = 2;
                    입력 = -1;
                }
                if (화면 == 1 && 세부1 == 3 && 세부2 == 0 && 입력 >=1 && 입력 <=회복물약가방크기) {
                    아이템정보 = 플레이어.회복물약가방.get(입력 -1);
                    살펴보기출력=true;
                    입력 = -1;
                }
                if (화면 == 1 && 세부1 == 3 && 세부2 == 0 && 입력 >회복물약가방크기 && 입력 <=전체가방크기){
                    아이템정보 = 플레이어.소지품.get(입력 -3);
                    살펴보기출력=true;
                    입력 = -1;
                }
            }
            ...
            //2-0-0 시작
            {
                if (화면 == 2 && 세부1 == 0 && 세부2 == 0 && 입력 == 0) {
                    화면 = 1;
                    입력 =-1;
                }
                if (화면 == 2 && 세부1 == 0 && 세부2 == 0 && 입력 == 1) {
                    세부1 = 1;
                    입력 =-1;
                }
                if (화면 == 2 && 세부1 == 0 && 세부2 == 0 && 입력 == 2) {
                    세부1 = 2;
                    입력 =-1;
                }
                if (화면 == 2 && 세부1 == 0 && 세부2 == 0 && 입력 == 3) {
                    세부1 = 4;
                    세부2 = 2; //세부2가 1이면 마을에서 휴식, 2면 사냥터에서 휴식
                    입력 =-1;
                }
                if (화면 == 2 && 세부1 == 2 && 세부2 == 0 && 입력 == 0) {
                    화면 = 2;
                    세부1 = 0;
                    입력 =-1;
                }
                if (화면 == 2 && 세부1 == 2 && 세부2 == 0 && 입력 == 1) {
                    화면 = 2;
                    세부2 = 1;
                    입력 =-1;
                }
                if (화면 == 2 && 세부1 == 2 && 세부2 == 0 && 입력 == 2) { // 버리기 메소드
                    세부2 = 2;
                    입력 =-1;
                }
                if (화면 == 2 && 세부1 == 2 && 세부2 == 0 && 입력 == 3) {
                    세부1 = 3;
                    입력 =-1;
                }
                if (화면 == 2 && 세부1 == 2 && 세부2 == 1 && 입력 == 0) {
                    세부2 = 0;
                    입력 =-1;
                }
                if (화면 == 2 && 세부1 == 2 && 세부2 == 1 && 입력 >=1 && 입력 <=전체가방크기) {//
                    아이템사용=true; //아이템 사용 스크립트 실행용
                    //이 아래는 버리기와 장착하기 에도 동일하게 쓰임
                    if(입력 <=회복물약가방크기){ //회복물약 내용물을 선택했다면
                        사용선택= 입력 -1;
...
//                    System.out.println("물약여부 : " + 물약여부);
                ...
                if (화면 == 2 && 세부1 == 2 && 세부2 == 2 && 입력 == 0) {
                    세부2 = 0;
                    입력 = -1;
                }
                if (화면 == 2 && 세부1 == 2 && 세부2 == 2 && 입력 >=1 && 입력 <=전체가방크기) {//사용하기 복사한 버리기
                    아이템버리기 = true; //아이템 버리기 스크립트 실행용
                    if (입력 <= 회복물약가방크기) { //회복물약 내용물을 선택했다면
                        System.out.println("\n회복물약은 버릴 수 없습니다.");
                        Thread.sleep(1000);
                ...
                if (화면 == 2 && 세부1 == 3 && 세부2 == 0 && 입력 == 0) {
                    세부1 = 2;
                    입력 = -1;
                }
                if (화면 == 2 && 세부1 == 3 && 세부2 == 0 && 입력 >=1 && 입력 <=회복물약가방크기) {
                    아이템정보 = 플레이어.회복물약가방.get(입력 -1);
                    살펴보기출력=true;
                    입력 = -1;
                }
                if (화면 == 2 && 세부1 == 3 && 세부2 == 0 && 입력 >회복물약가방크기 && 입력 <=전체가방크기){
                    아이템정보 = 플레이어.소지품.get(입력 -3);
                    살펴보기출력=true;
                    입력 = -1;
                }
            ...
            {
                if (화면 == 3 && 세부1 == 0 && 세부2 == 0 && 입력 == 0) { // 300에서 0(나가기)를 선택
                    화면 = 1;
                    입력 =-1;
                }
                if (화면 == 3 && 세부1 == 0 && 세부2 == 0 && 입력 == 1) { // 300에서 1(구매하기)를 선택
                    세부1 = 1;
                    입력 =-1;
                }
                if (화면 == 3 && 세부1 == 0 && 세부2 == 0 && 입력 == 2) { // 300에서 2(판매하기)를 선택
                    세부1 = 2;
                    입력 =-1;
                }
                if (화면 == 3 && 세부1 == 0 && 세부2 == 0 && 입력 == 3) { // 300에서 3(살펴보기)를 선택
                    세부1 = 3;
                    입력 =-1;
                }
                if (화면 == 3 && 세부1 == 1 && 세부2 == 0 && 입력 == 0) { // 310에서 0(취소)를 선택
                    세부1 = 0;
                    입력 =-1;
                }
                if (화면 == 3 && 세부1 == 1 && 세부2 == 0 && 입력 >= 1 && 입력 <= 상점판매개수.size()) { // 310에서 입력값이 1이상이며 상점리스트개수 이하일때
                    세부2 = 1;
                    상점구매 = 입력; //뭘 눌러서 구매확인창이 떴는지 확인
                    입력 =-1;
...
//                    System.out.println(상점.상점구매타겟(상점구매)+"을(를) 구매했습니다.");//변수 '상점구매' 값에 따라 품목명을 다르게 넣기
                if (화면 == 3 && 세부1 == 1 && 세부2 == 1 && 스택가능==1 && 입력 ==0) { // 스택가능한 아이템을 선택했을 때, 0을 입력했을 경우
                    세부2 = 0;
                    상점구매 = 0;
                    스택가능=0;
                    입력 = -1;
                }
                if (화면 == 3 && 세부1 == 1 && 세부2 == 1 && 스택가능==1 && 입력 >=1) { // (구매 개수 선택창)스택가능한 아이템을 선택했을 때, 1이상의 숫자를 입력했을 때
                ...
                if (화면 == 3 && 세부1 == 1 && 세부2 == 1 && 스택가능==2 && 입력 ==0) { //스택 불가능한 아이템을 선택했을 때, 0을 입력했을 경우
                    세부2 = 0;
                    상점구매 = 0;
                    스택가능=0;
                    입력 = -1;
                }
                if (화면 == 3 && 세부1 == 1 && 세부2 == 1 && 스택가능==2 && 입력 ==1) { //스택 불가능한 아이템을 선택했을 때 1(구매하기)을 입력했을 경우
                    세부2 = 0;
                    구매개수= 입력;
                    상점구매확인1=true;
                    입력 = -1;
                }
                if (화면 == 3 && 세부1 == 2 && 세부2 == 0 && 입력 == 0) { //320에서 0(취소)를 선택
                    세부1 = 0;
                    입력 = -1;
                }
                if (화면 == 3 && 세부1 == 2 && 세부2 == 0 && 입력 >= 1 && 입력 <= 전체가방크기) { // 320에서 입력값이 1이상이며 소지품 개수 이하일 때
                    세부2 = 1;
                    상점판매 = 입력; //뭘 눌러서 구매확인창이 떴는지 확인
                    입력 = -1;
...
//                        System.out.println("@@@@@@@@@@캐릭터.소지품.get(상점판매-3)는 " + 캐릭터.소지품.get(상점판매-3).아이템이름);
                        if(플레이어.소지품.get(상점판매-3).스택가능여부){ //스택가능여부가 true면
                            스택가능=1;
                            물약여부=2;
                        }
                        else{
                ...
                if (화면 == 3 && 세부1 == 2 && 세부2 == 1 && 스택가능==1 && 입력 == 0) { //상점 판매개수 확인창에서 0을 입력할경우
                    세부2 = 0;
                    상점판매 = 0;
                    스택가능=0;
                    입력 = -1;
                }
                if (화면 == 3 && 세부1 == 2 && 세부2 == 1 && 스택가능==1 && 입력 >=1 && 물약여부==1) { //321이고 스택가능한 아이템이고 b가 1이상이고 물약일때
//                    System.out.println("@@@@@"+캐릭터.회복물약가방.get(상점판매-1).스택수);
                    if(입력 <= 플레이어.회복물약가방.get(상점판매-1).스택수) {//스택수 이하의 숫자를 입력했을 때
                        세부2 = 0;
                        판매개수 = 입력;
                        상점판매확인1 = true;
                        입력 = -1;
                ...
                if (화면 == 3 && 세부1 == 2 && 세부2 == 1 && 스택가능==1 && 입력 >=1 && 물약여부==2) { //321이고 스택가능한 아이템이고 b가 1이상이고 물약이 아닐때
//                    System.out.println("@@@@@"+캐릭터.소지품.get(상점판매-3).스택수);
                    if(입력 <= 플레이어.소지품.get(상점판매-3).스택수) {
                        세부2 = 0;
                        판매개수 = 입력;
                        상점판매확인1 = true;
                        입력 = -1;
                ...
                if (화면 == 3 && 세부1 == 2 && 세부2 == 1 && 스택가능==2 && 입력 == 0) { //상점 판매확인창(스택불가능)에서 0(취소) 를 입력했을 경우
                    세부2 = 0;
                    상점판매 = 0;
                    스택가능=0;
                    입력 = -1;
                }
                if (화면 == 3 && 세부1 == 2 && 세부2 == 1 && 스택가능==2 && 입력 == 1) { //상점 판매확인창(스택불가능)에서 1(확인) 을 입력했을 경우
                    세부2 = 0;
                    판매개수= 1;
                    상점판매확인1=true;
                    입력 = -1;
                ...
                //상점은 살펴보기를 넣기 애매함
//                if (화면 == 3 && 세부1 == 3 && 세부2 == 0 && 입력 == 0) { //330에서 0(취소)를 선택
//                    세부1 = 0;
//                    입력 = -1;
//                }
//                if (화면 == 3 && 세부1 == 3 && 세부2 == 0 && 입력 >=1 && 입력<=회복물약가방크기) {
//                    아이템정보 = 캐릭터.회복물약가방.get(입력-1);
//                    살펴보기출력=true;
//                    입력 = -1;
//                }
//                if (화면 == 3 && 세부1 == 3 && 세부2 == 0 && 입력 >회복물약가방크기 && 입력<=전체가방크기){
//                    System.out.println("전체가방크기 : "+전체가방크기);
//                    아이템정보 = 캐릭터.소지품.get(입력-3);
//                    살펴보기출력=true;
//                    입력 = -1;
//                }
            ...
            //4-0-0 시작
            {
                if (화면 == 4 && 세부1 == 0 && 세부2 == 0 && 입력 == 0) {//400에서 0(나가기)를 선택
                    화면 = 1;
                    입력 = -1;
                }
                if (화면 == 4 && 세부1 == 0 && 세부2 == 0 && 입력 == 1) {
                    세부1 = 1;
                    입력 = -1;
                }
                if (화면 == 4 && 세부1 == 0 && 세부2 == 0 && 입력 == 2) {
                    세부1 = 2;
                    입력 = -1;
                }
                if (화면 == 4 && 세부1 == 1 && 세부2 == 0 && 입력 == 0) { //뭐 강화할지 선택하는 창(410)에서 나가기 누를시
                    세부1 = 0;
                    입력 = -1;
                }
                if (화면 == 4 && 세부1 == 1 && 세부2 == 0 && 입력 >= 1 && 입력 <= 플레이어.강화목록.size()) {
                    세부2 = 1;
                    강화선택 = 입력; //뭘 눌러서 강화확인창이 떴는지 확인
                    입력 = -1;
                }
                if (화면 == 4 && 세부1 == 1 && 세부2 == 1 && 입력 == 0) { //강화확인창(411)에서 0(취소)를 누를경우
                    세부2 = 0;
                    강화선택 = 0;
                    입력 = -1;
                }
                if (화면 == 4 && 세부1 == 1 && 세부2 == 1 && 입력 == 1) { //411에서 1(강화하기)를 선택
                    System.out.println(아이템정보.아이템이름+"을(를) 강화합니다.");
                    세부2 = 0;
                    강화확인 = true;
                    입력 = -1;
                }
                if (화면 == 4 && 세부1 == 2 && 세부2 == 0 && 입력 == 0) { //420에서 0(취소하기)를 선택
                    세부1 = 0;
                    입력 = -1;
                }
                if (화면 == 4 && 세부1 == 2 && 세부2 == 0 && 입력 >= 1 && 입력 <= 플레이어.강화목록.size()) { //420에서 1이상을 선택
            ...
            //5-0-0(전투화면) 시작
            {
                if (화면 == 5 && 세부1 == 0 && 세부2 == 0 && 입력 == 1) {
                    세부1 = 1;
                    입력 = -1;
                }
                if (화면 == 5 && 세부1 == 0 && 세부2 == 0 && 입력 == 2) {
                    세부1 = 2;
                    입력 = -1;
                }
                if (화면 == 5 && 세부1 == 0 && 세부2 == 0 && 입력 == 3) {
                    세부1 = 3;
                    입력 = -1;
                }
                if (화면 == 5 && 세부1 == 0 && 세부2 == 0 && 입력 == 4) {
                    세부1 = 4;
                    입력 = -1;
                }
                if (화면 == 5 && 세부1 == 0 && 세부2 == 0 && 입력 == 5) {
                    세부1 = 5;
                    입력 = -1;
                }
                if (화면 == 5 && 세부1 == 1 && 세부2 == 0 && 입력 == 0) {
                    세부1 = 0;
                    입력 = -1;
                }
                if (화면 == 5 && 세부1 == 1 && 세부2 == 0 && 입력 > 0 && 입력 <= 몬스터머릿수 - 죽은몬스터수) { //공격실행
                    //기본공격으로 몬스터중 하나를 선택했을 때
                    몬스터타겟 = 몬스터어레이.get(입력 -1);
//                    몬스터어레이.set(입력-1, 캐릭터.캐릭터공격(몬스터타겟)); //공격에 맞은 타겟의 정보를 몬스터어레이에 덮어씌움
                    플레이어.캐릭터공격(몬스터타겟);
                    몬스터삭제 = true;
                    세부1 = 0;
                    입력 = -1;
...
//                    몬스터타겟 = null;
                ...
                if (화면 == 5 && 세부1 == 2 && 세부2 == 0 && 입력 == 0) {
                    세부1 = 0;
                    입력 = -1;
                }
                if (화면 == 5 && 세부1 == 2 && 세부2 == 0 && 입력 >= 1 && 입력 <= 플레이어.스킬목록.size()) {
                    스킬 = 플레이어.스킬목록.get(입력 -1);
                    세부2 = 1;
                    입력 = -1;
                }
                if (화면 == 5 && 세부1 == 2 && 세부2 == 1 && 입력 == 0) {
                    스킬 = null;
                    세부1 = 2;
                    세부2 = 0;
                    입력 = -1;
                }
                if (화면 == 5 && 세부1 == 2 && 세부2 == 1 && 스킬.타입 == 1 && 입력 >= 1 && 입력 <= 몬스터머릿수 - 죽은몬스터수) { //단일스킬 실행
                ...
                if (화면 == 5 && 세부1 == 2 && 세부2 == 1 && 스킬.타입 == 3 && 입력 == 1 ) { //광역스킬 실행
                ...
                if (화면 == 5 && 세부1 == 3 && 세부2 == 0 && 입력 == 0) {
                    세부1 = 0;
                    입력 = -1;
                }
                if (화면 == 5 && 세부1 == 3 && 세부2 == 0 && 입력 >=1 && 입력 <=전체가방크기) {//
                    전투아이템사용=true; //전투아이템 사용 스크립트 실행용
                    세부2=1;
                    if(입력 <=회복물약가방크기){ //회복물약 내용물을 선택했다면
                        사용선택= 입력 -1;
                        물약여부=1;
                        아이템정보 = 플레이어.회복물약가방.get(사용선택);
...
//                    System.out.println("물약여부 : " + 물약여부);
                ...
                if (화면 == 5 && 세부1 == 3 && 세부2 == 1 && 입력 == 1) {
                    최종확인=true;
                    세부1 = 0;
                    세부2 = 0;
                    입력 = -1;
                }
                if (화면 == 5 && 세부1 == 4 && 세부2 == 0 && 입력 == 0) {
                    세부1 = 0;
                    입력 = -1;
                }
                if (화면 == 5 && 세부1 == 4 && 세부2 == 0 && 입력 > 0 && 입력 <= 몬스터머릿수 - 죽은몬스터수) {
                    몬스터타겟 = 몬스터어레이.get(입력 -1);
                ...
                if (화면 == 5 && 세부1 == 5 && 세부2 == 0 && 입력 == 0) {
                    세부1 = 0;
                    입력 = -1;
                }
                if (화면 == 5 && 세부1 == 5 && 세부2 == 0 && 입력 == 1) {
...
//                        System.out.println("물약사용메소드 호출");
                        플레이어.아이템사용(물약여부, 사용선택);
                    }
                    else{ //물약이 아니면
//                        System.out.println("아이템장착메소드 호출");
                        if(플레이어.소지품.get(사용선택).착용가능여부){ //착용가능하면
                            플레이어.아이템장착(사용선택);
                        }
...
//                        System.out.println("전투중 소모아이템사용메소드 호출");
                ...
                if (화면 == 2 && 세부1 == 4) {
                    ...
                    if (플레이어.캐릭터최종체력 - 플레이어.캐릭터현재체력 >= 300) {
                        ...
                        System.out.print("\n체력이 300회복되어 " + 플레이어.캐릭터현재체력 + "이(가) 되었습니다.");

                    } else {
                        System.out.print("\n체력이 " + (플레이어.캐릭터최종체력 - 플레이어.캐릭터현재체력) + "회복되어 ");
                        플레이어.캐릭터현재체력 = 플레이어.캐릭터최종체력;
                        System.out.print(플레이어.캐릭터현재체력 + "이(가) 되었습니다.");
                    }
                    if (플레이어.캐릭터최종마나 - 플레이어.캐릭터현재마나 >= 30) {
                        플레이어.캐릭터현재마나 = 플레이어.캐릭터현재마나 + 30;
                        System.out.print("\n체력이 30회복되어 " + 플레이어.캐릭터현재마나 + "이(가) 되었습니다.");

                    } else {
                        System.out.print("\n체력이 " + (플레이어.캐릭터최종마나 - 플레이어.캐릭터현재마나) + "회복되어 ");
                        플레이어.캐릭터현재마나 = 플레이어.캐릭터최종마나;
                        System.out.print(플레이어.캐릭터현재마나 + "이(가) 되었습니다.");
                    }
                    System.out.print("" +
                            "\n계속하려면 아무 숫자나 입력하세요." +
                            "\n→");
...
//                    System.out.println("스킬발동");
                    스킬발동=false;
                    if(플레이어.캐릭터현재마나>=스킬.소모량) { //현재마나가 소모량 이상이면
                        if (스킬.타입 == 1) {
...
//                                System.out.println("몬스터어레이와 i의 값이 같아졌으므로 몬스터삭제를 false로 함.");
                ...
                if (화면 == 5 && 턴 && 몬스터머릿수 - 죽은몬스터수 >= 1) {
                    사망 = 몬스터.몬스터공격(몬스터어레이, 몬스터머릿수 - 죽은몬스터수, 플레이어);
                    세부1 = 0;
                    세부2 = 0;
                    턴 = false;
                }
                ...
                //전투정산 시작
                if(전투종료){//전투종료시
                    플레이어.전투정산(전투승리,드랍템,경험치허브,소지금허브);
                    전투승리 = false;
                    전투종료 = false;
                    드랍템.clear(); //
                    경험치허브 = 0;

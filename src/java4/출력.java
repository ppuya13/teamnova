...
public class 출력 { //화면에 표시하기 위한 메소드는 이곳에
    ...
    public StringBuilder 능력치창(){
        ...
        StringBuilder 능력치표기 = new StringBuilder("" +
                ...
                "\n│치명확률: " + (플레이어.캐릭터치명확률 + 플레이어.레벨업추가치확) + "% + " + 플레이어.캐릭터추가치확 + "%" +
                "\n│치명피해: " + (플레이어.캐릭터치명피해 + 플레이어.레벨업추가치피) + "% + " + 플레이어.캐릭터추가치피 + "%" +
                "\n│회피율: " + 플레이어.캐릭터회피 + "% + " + 플레이어.캐릭터추가회피 + "%" +
                "\n│속도: " + (플레이어.캐릭터속도 + 플레이어.레벨업추가속도) + " +" + 플레이어.캐릭터추가속도 +
                "\n└──────────────────");

...
//                    System.out.println("System : 몬스터 어레이를 초기화합니다.");
                    ...
                    System.out.print(""+
                            "\n강화는 1회에 500골드가 소모되며, 최대 10번까지 강화할 수 있습니다." +
                            "\n강화의 성공확률은 100%입니다." +
                            "\n강화할 아이템을 선택해주세요." +
                            "\n→");
                    ...
                    else if(캐릭터.소지금<500){ //캐릭터의 소지금이 500미만이라면
                        System.out.println("\n소지금이 부족합니다.");
                        패스=true;
                        세부2=0;
                        Thread.sleep(1000);
...
//            }
            ...
            //1-0-0 시작
            {
                ...
                if (화면 == 1 && 세부1 == 2 && 세부2 == 1 && a == 0) { //1-2-1일땐 0입력이 필요하므로 b를 사용
                    세부2 = 0;
                    a = -1;
                }
                if (화면 == 1 && 세부1 == 2 && 세부2 == 1 && a>=1 && a<=전체가방크기) {//1-2-1일땐 0입력이 필요하므로 b를 사용
...
//                    System.out.println("강화스크립트 발동");
                ...
                //인벤살펴보기 시작
                if(살펴보기출력&& 화면!=4){
                    System.out.println(메인.살펴보기(아이템정보, 물약여부));

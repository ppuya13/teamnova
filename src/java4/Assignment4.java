...
//                    System.out.println("System : 몬스터 어레이를 초기화합니다.");
                    ...
                    System.out.print("" +
                            상점.상점구매타겟(상점구매) +
                            "을(를) 몇 개 구매하시겠습니까? (0개: 취소)" +//변수 '상점구매' 값에 따라 품목 이름을 바꿔넣기 //구현완료
                            "\n→");
...
//                    System.out.println(상점.상점구매타겟(상점구매)+"을(를) 구매했습니다.");//변수 '상점구매' 값에 따라 품목명을 다르게 넣기
                ...
                if (화면 == 3 && 세부1 == 1 && 세부2 == 1 && 스택가능==1 && b>=1) { // 스택가능한 아이템을 선택했을 때, 1이상의 값을 입력했을 경우
                    세부2 = 0;
                    구매개수 = b;
                    상점구매확인1 = true;
                    b = -1;
                ...
                if (화면 == 3 && 세부1 == 1 && 세부2 == 1 && 스택가능==2 && b==0) { //상점 구매확인창에서 0을 입력했을 경우
                    세부2 = 0;
                    상점구매 = 0;
                    b = -1;
                }

...
public class Assignment4 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //캐릭터 초기화
        String[] 인벤토리허브=new String[20];

        능력치 캐릭터 = new 능력치(1,100,0,1000,1000,100,100,500,0,10,0,20,150,10,0);
        캐릭터.인벤토리초기화(캐릭터);
...
//                    System.out.println(메인화면.몬스터목록(몬스터머릿수,몬스터어레이,죽은몬스터수));
                    //특수스크립트에서 몬스터 정보를 생성한 뒤 몬스터 정보를 출력함
                    //Ex) 고블린1 고블린2 오크1 이(가) 나타났다!
                    패스 = true;
                    화면=5;
                    세부1=0;
                }
                ...
                System.out.print("" +
                        "\n인벤토리를 열어봅니다." +
                        "\n회복용 물약을 제외한 아이템은 총 20종류까지만 보관이 가능합니다." +
                        "\n체력물약 : 0개" +
                        "\n마나물약 : 0개" +
                        "\n검" +
                        "\n방패" +
                ...
                System.out.print("" +
                        "\n체력포션을(를) 구매하시겠습니까?" +//변수 '상점구매' 값에 따라 품목 이름을 바꿔넣기
                        "\n1.확인" +
                        "\n2.취소" +
                        "\n→");
            }
...
//            }
            ...
            //3-0-0 시작 / 나가기 조건은 현재 7번이지만 상점 품목들을 배열로 놓고 length를 써서 적용해보기.
            {
                ...
                if (화면 == 3 && 세부1 == 1 && 세부2 == 0 && a == 1) { // 310에서 1(취소)를 선택
                    세부1 = 0;
                    a = 0;
                }
                if (화면 == 3 && 세부1 == 1 && 세부2 == 0 && a >= 2 && a <= 7) { // 310에서 입력값이 2이상, 7이하일때 이지만 length를 적용해보기
                    세부2 = 1;
                    상점구매 = a; //뭘 눌러서 구매확인창이 떴는지 확인
                    a = 0;
                }
                if (화면 == 3 && 세부1 == 1 && 세부2 == 1 && a == 1) { //상점 구매확인창에서 구매하기를 누를 경우
                    System.out.println("체력포션을(를) 구매했습니다.");//변수 '상점구매' 값에 따라 품목명을 다르게 넣기
                    세부2 = 0;
                    상점구매확인1 = true;
                    a = 0;
                }
                ...
                if (화면 == 3 && 세부1 == 2 && 세부2 == 0 && a == 1) { //320에서 1(취소)를 선택
                    세부1 = 0;
                    a = 0;
                }
                if (화면 == 3 && 세부1 == 2 && 세부2 == 0 && a >= 2 && a <= 9) { //320에서 입력값이 2이상, 9이하일때 이지만 length를 적용해보기
                    세부2 = 1;
                    상점판매 = a; //뭘 눌러서 판매확인창이 떳는지 확인
                    a = 0;
                }

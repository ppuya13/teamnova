...
public class 아이템 { //아이템 정보는 이곳에
    ...
    public void 검(){
        ...
        this.구매가격=100;
        this.판매가격=50;
        this.아이템효과="장비 아이템(무기): 휘두르기 좋은 검입니다.";
        this.기본공격력=10;
        this.기본방어력=0;
        this.기본체력=0;
        this.기본마나=0;
    ...
    public void 방패(){
        ...
        this.구매가격=100;
        this.판매가격=50;
        this.아이템효과="장비 아이템(보조장비): 품질 좋은 방패입니다.";
        this.기본공격력=0;
        this.기본방어력=10;
        this.기본체력=0;
        this.기본마나=0;
    ...
    public void 각반(){
        ...
        this.구매가격=100;
        this.판매가격=50;
        this.아이템효과="장비 아이템 : 장착시 방어력을 10 증가시킵니다.";
        this.기본공격력=0;
        this.기본방어력=10;
        this.기본체력=0;
        this.기본마나=0;
    ...
    public void 공격력물약(){
        ...
        this.구매가격=50;
        this.판매가격=25;
        this.아이템효과="사용 아이템 : 사용시 공격력을 10 증가시킵니다.";
    }
    public void 슬라임젤리(){
        this.고유번호=300;
        this.아이템분류=3;
